                ...
                memset(input_si_entry_121, 0, sizeof(*input_si_entry_121));
                {
                    ...
                    if (ret == MPE_SUCCESS && count == sizeof(*input_si_entry))
                    {
                        ...
                        for (list_idx = 0; list_idx < 3; list_idx++)
                        {
                            int i = 0;
                            int tmp_limit = 0;
                            if(0 > name_counts[list_idx])  /*Coverity Maximum value for the tmp_limit  required to be defined*/
                            {
                                tmp_limit = 0;
                            }
                            else if(name_counts[list_idx] > NAME_COUNT_MAX)
                            {
                                    tmp_limit = NAME_COUNT_MAX;
                            }
                            else
                            {
                                tmp_limit= name_counts[list_idx];
                            }
            ...
            if (err == MPE_SUCCESS && input_si_entry != NULL)
            {
                memset(input_si_entry, 0, sizeof(*input_si_entry));
                {
                    ...
                    if (ret == MPE_SUCCESS && count == sizeof(*input_si_entry))
                    {
                        ...
                        int name_count =0;
                        if(0 > ((int)(input_si_entry->descriptions)))  /*Coverity Maximum value for the tmp_limit  required to be defined*/
                        {
                            name_count = 0;
                        }
                        else if(((int)(input_si_entry->descriptions)) > NAME_COUNT_MAX)
                        {
